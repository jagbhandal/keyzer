...
STATES = [
    ...
    ("lighting / rainbow (no colour controls)", {"KEYZER_LIGHTPANEL": "1", "KEYZER_LIGHTFX": "spectrum"}),
    ("lighting / wave (direction)", {"KEYZER_LIGHTPANEL": "1", "KEYZER_LIGHTFX": "wave"}),
    ("lighting / react on zone (colour + speed)", {"KEYZER_LIGHTPANEL": "1", "KEYZER_LIGHTFX": "reactive", "KEYZER_LIGHTZONE": "scroll_wheel"}),
